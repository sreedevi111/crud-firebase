...
import { editCategory, getcategories } from '../../../Redux/Actions/categoryAction'
...
const EditCategory = ({ navigation, route }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white', padding: 20 }}>
      ...
      <TextInput value={label} onChangeText={text => set_label(text)} style={{ color: 'black', marginVertical: 10, padding: 3, borderWidth: 1, borderRadius: 5, borderColor: 'grey' }} />
